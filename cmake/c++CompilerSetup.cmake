...
if(NOT EXTRA_LIBS STREQUAL "")
  string(REPLACE ";" " -l" EXTRA_LIBS_INTERMEDIATE "-l${EXTRA_LIBS}")
  #Fixes any linker flags that are not just libraries
  string(REPLACE "-l-" "-" STR_EXTRA_LIBS "${EXTRA_LIBS_INTERMEDIATE}")
endif()
