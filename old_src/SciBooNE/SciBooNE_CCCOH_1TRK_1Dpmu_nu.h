...
#ifndef SCIBOONE_CCCOH_1TRK_1DPMU_NU_H_SEEN
...
//******************************************************************** 
class SciBooNE_CCCOH_1TRK_1Dpmu_nu : public Measurement1D {
//******************************************************************** 

public:

  SciBooNE_CCCOH_1TRK_1Dpmu_nu(nuiskey samplekey);
  virtual ~SciBooNE_CCCOH_1TRK_1Dpmu_nu() {};
