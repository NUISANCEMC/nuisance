...
#ifndef SCIBOONE_CCCOH_1TRK_1DTHETAMU_NU_H_SEEN
#define SCIBOONE_CCCOH_1TRK_1DTHETAMU_NU_H_SEEN

#include "Measurement1D.h"
#include "SciBooNEUtils.h"

//******************************************************************** 
class SciBooNE_CCCOH_1TRK_1Dthetamu_nu : public Measurement1D {
//******************************************************************** 

public:

  SciBooNE_CCCOH_1TRK_1Dthetamu_nu(nuiskey samplekey);
  virtual ~SciBooNE_CCCOH_1TRK_1Dthetamu_nu() {};
