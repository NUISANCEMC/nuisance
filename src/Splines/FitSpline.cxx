...
//TODO (P.Stowell) ReWrite Spline Classes to be more efficient. Make inheritance system.
...
//*************************************************
  ...
  // ETC
  std::vector<std::string> parsed_points = GeneralUtils::ParseToStr(points_def,";");
  for (UInt_t i = 0; i < parsed_points.size(); i++){
    ...
    std::vector<double> points_temp = GeneralUtils::ParseToDbl(choose_points, ",");
