...
//******************************************************************** 
  ...
  // Measurement Details
  measurementName = "MINERvA_CC0pi_1DThetae_nue";
  ...
  this->SetDataFromFile(datafile, "Data_1DThetae");
  this->SetCovarFromDataFile(datafile, "Covar_1DThetae");
  ...
  nue_sample    = new MINERvA_CC0pi_XSec_1DFill_nue(neutrinosample, rw, type, fakeDataFile, true, 2);
  nuebar_sample = new MINERvA_CC0pi_XSec_1DFill_nue(antineutrinosample, rw, type, fakeDataFile, false, 2);
  ...
  // Get combined flux and event rate hists;
