...
/*
  Authors: Clarence Wret
*/

#include "MINERvA_CC0pi_XSec_2D_ME_nu.h"
#include "MINERvA_SignalDef.h"

//********************************************************************
void MINERvA_CC0pi_XSec_2D_ME_nu::SetupDataSettings() {
  //********************************************************************
...
//********************************************************************
MINERvA_CC0pi_XSec_2D_ME_nu::MINERvA_CC0pi_XSec_2D_ME_nu(nuiskey samplekey) {
  //********************************************************************
  ...
  fMapHist = new TH2I("MINERvA_CC0pi_XSec_2D_ME_nu_maphist", "",
...
//********************************************************************
void MINERvA_CC0pi_XSec_2D_ME_nu::FillEventVariables(FitEvent *event) {
  //********************************************************************
...
//********************************************************************
bool MINERvA_CC0pi_XSec_2D_ME_nu::isSignal(FitEvent *event) {
  //********************************************************************
  // Check outgoing muon is at least 1.5 GeV
  TLorentzVector Pmu = event->GetHMFSParticle(13)->fP;
  if (Pmu.Vect().Mag() < 1.5) return false;

  bool signal = SignalDef::isCC0pi_MINERvAPTPZ(event, 14, EnuMin, EnuMax);
