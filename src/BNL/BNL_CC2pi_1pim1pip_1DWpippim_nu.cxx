...
#include "BNL_CC2pi_1pim1pip_1DWpippim_nu.h"


//********************************************************************
BNL_CC2pi_1pim1pip_1DWpippim_nu::BNL_CC2pi_1pim1pip_1DWpippim_nu(nuiskey samplekey) {
//********************************************************************

  // Sample overview ---------------------------------------------------
  std::string descrip = "BNL_CC2pi_1pim1pip_1DWpippim_nu sample. \n" \
                        "Target: D2 \n" \
                        "Flux:  \n" \
                        "Signal:  \n";
...
void BNL_CC2pi_1pim1pip_1DWpippim_nu::FillEventVariables(FitEvent *event) {
...
bool BNL_CC2pi_1pim1pip_1DWpippim_nu::isSignal(FitEvent *event) {
