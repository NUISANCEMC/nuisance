...
SciBooNE_CCCOH_1TRK_1Dthetamu_nu::SciBooNE_CCCOH_1TRK_1Dthetamu_nu(nuiskey samplekey){
  ...
  fSettings.SetDataInput(  FitPar::GetDataBase()+"/SciBooNE/SB_COH_Fig7.30a_thetamu.csv");
...
void SciBooNE_CCCOH_1TRK_1Dthetamu_nu::FillEventVariables(FitEvent *event){
...
bool SciBooNE_CCCOH_1TRK_1Dthetamu_nu::isSignal(FitEvent *event){
...
void SciBooNE_CCCOH_1TRK_1Dthetamu_nu::FillExtraHistograms(MeasurementVariableBox* vars, double weight){
