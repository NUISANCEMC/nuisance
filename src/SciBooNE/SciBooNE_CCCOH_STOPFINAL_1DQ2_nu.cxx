...
SciBooNE_CCCOH_STOPFINAL_1DQ2_nu::SciBooNE_CCCOH_STOPFINAL_1DQ2_nu(std::string name, std::string inputfile,
  ...
  this->SetDataValues(FitPar::GetDataBase()+"/SciBooNE/SB_COH_Fig13_CVs.csv");
...
bool SciBooNE_CCCOH_STOPFINAL_1DQ2_nu::isSignal(FitEvent *event){
  ...
  // Apply the kinematic cuts
  if (SciBooNEUtils::CalcThetaPr(event) < 20) return false;
  if (SciBooNEUtils::CalcThetaPi(event) > 90) return false;
...
void SciBooNE_CCCOH_STOPFINAL_1DQ2_nu::ScaleEvents(){
...
void SciBooNE_CCCOH_STOPFINAL_1DQ2_nu::FillHistograms(){
...
void SciBooNE_CCCOH_STOPFINAL_1DQ2_nu::Write(std::string drawOpt){
...
void SciBooNE_CCCOH_STOPFINAL_1DQ2_nu::ApplyNormScale(double norm){
...
void SciBooNE_CCCOH_STOPFINAL_1DQ2_nu::ResetAll(){
