...
SciBooNE_CCCOH_MuPiNoVA_1Dthetapi_nu::SciBooNE_CCCOH_MuPiNoVA_1Dthetapi_nu(std::string name, std::string inputfile,
  ...
  // Setup Plots
  this->fPlotTitles = "; Pion track angle (degrees); Entries/5 degrees";
  this->SetDataValues(FitPar::GetDataBase()+"/SciBooNE/SB_COH_Fig12_CVs.csv");
...
void SciBooNE_CCCOH_MuPiNoVA_1Dthetapi_nu::FillEventVariables(FitEvent *event){
  ...
  thetapi = SciBooNEUtils::CalcThetaPi(event);
...
bool SciBooNE_CCCOH_MuPiNoVA_1Dthetapi_nu::isSignal(FitEvent *event){
  // Also need to add the theta_proton > 20 deg. cut here
  return SciBooNEUtils::isMuPiSignal(event, false);
};


void SciBooNE_CCCOH_MuPiNoVA_1Dthetapi_nu::ScaleEvents(){
...
void SciBooNE_CCCOH_MuPiNoVA_1Dthetapi_nu::FillHistograms(){
...
void SciBooNE_CCCOH_MuPiNoVA_1Dthetapi_nu::Write(std::string drawOpt){
...
void SciBooNE_CCCOH_MuPiNoVA_1Dthetapi_nu::ApplyNormScale(double norm){
...
void SciBooNE_CCCOH_MuPiNoVA_1Dthetapi_nu::ResetAll(){
