...
SciBooNE_CCCOH_MuPr_1Dpmu_nu::SciBooNE_CCCOH_MuPr_1Dpmu_nu(nuiskey samplekey){
  ...
  fSettings.SetDataInput(  FitPar::GetDataBase()+"/SciBooNE/SB_COH_Fig7.30b_pmu.csv");
...
void SciBooNE_CCCOH_MuPr_1Dpmu_nu::FillEventVariables(FitEvent *event){
...
bool SciBooNE_CCCOH_MuPr_1Dpmu_nu::isSignal(FitEvent *event){
...
void SciBooNE_CCCOH_MuPr_1Dpmu_nu::FillExtraHistograms(MeasurementVariableBox* vars, double weight){
