...
class T2K_CC1Pip_CH_xsec_muproj_nu : public MultiDataComparison {

public:
  T2K_CC1Pip_CH_xsec_muproj_nu()
      : MultiDataComparison("T2K_CC1Pip_CH_xsec_muproj_nu") {
...
// phi_adler.txt       theta_adler.root    Thetapion.txt
    ...
    std::unique_ptr<SimpleDataComparison_1D> MomentumPion(
        new SimpleDataComparison_1D("T2K_CC1Pip_CH_xsec_muproj_nu:MomentumPion"));
    ...
    IsSigFunc = [](FullEvent const &fev) -> bool {
      ...
      return t2k::IsCC1Pip_CH_MichTag(fev);
    };
  }
...
DECLARE_PLUGIN(IDataComparison, T2K_CC1Pip_CH_xsec_muproj_nu);
DECLARE_PLUGIN(IEventProcessor, T2K_CC1Pip_CH_xsec_muproj_nu);
