...
#ifndef ANL_CCQE_HEPDATA_H_SEEN
#define ANL_CCQE_HEPDATA_H_SEEN
...
class ANL_CCQE_HEPDATA : public Measurement1D {
public:

  ANL_CCQE_HEPDATA(nuiskey samplekey);
  virtual ~ANL_CCQE_HEPDATA() {}; 
