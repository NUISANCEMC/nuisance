#ifndef T2K_NUECCINC_XSEC_1DTHE_JOINT_H_SEEN
#define T2K_NUECCINC_XSEC_1DTHE_JOINT_H_SEEN

#include "JointMeas1D.h"
#include "Measurement1D.h"
#include "T2K_nueCCinc_XSec_1Dthe.h"

class T2K_nueCCinc_XSec_1Dthe_joint : public JointMeas1D {
public:

  T2K_nueCCinc_XSec_1Dthe_joint(nuiskey samplekey);
  virtual ~T2K_nueCCinc_XSec_1Dthe_joint() {};
