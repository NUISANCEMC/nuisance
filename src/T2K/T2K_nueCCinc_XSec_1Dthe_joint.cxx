...
//********************************************************************
T2K_nueCCinc_XSec_1Dthe_joint::T2K_nueCCinc_XSec_1Dthe_joint(nuiskey samplekey){
//********************************************************************

  fSettings = LoadSampleSettings(samplekey);
  std::string descrip = "T2K_nueCCinc_XSec_1Dthe_joint. \n"
    "Target: CH \n"
    "Flux: T2K FHC nue  \n"
    "Signal: CC-inclusive \n";
  fSettings.SetTitle("T2K #nu_{e}-CC-inclusive cos#theta_{e} joint");
  fSettings.DefineAllowedSpecies("nue, nueb");
  fSettings.SetCovarInput(FitPar::GetDataBase() + "/T2K/CCinc/nue_2019/fract_covar_thetae.txt");
  ...
  FHCNueKey.SetS("name", "T2K_nueCCinc_XSec_1Dthe_FHC");
  FHC_nue = new T2K_nueCCinc_XSec_1Dthe(FHCNueKey);

  nuiskey RHCNueKey = Config::CreateKey("sample");
  RHCNueKey.SetS("input", inFileRHCNue);
  RHCNueKey.SetS("type", fSettings.GetS("type"));
  RHCNueKey.SetS("name", "T2K_nueCCinc_XSec_1Dthe_RHC");
  RHC_nue = new T2K_nueCCinc_XSec_1Dthe(RHCNueKey);
  ...
  RHCNuebarKey.SetS("name", "T2K_nuebarCCinc_XSec_1Dthe_RHC");
  RHC_nuebar = new T2K_nueCCinc_XSec_1Dthe(RHCNuebarKey);
...
//********************************************************************
void T2K_nueCCinc_XSec_1Dthe_joint::SetFractCovarFromTextFile(std::string covfile){
//********************************************************************

  if (!fDataHist){
    NUIS_ERR(FTL, "fDataHist is required to call T2K_nueCCinc_XSec_1Dthe_joint::SetFractCovarFromTextFile");
    throw;
  }
...
//********************************************************************
void T2K_nueCCinc_XSec_1Dthe_joint::CombineDataHists(){
//********************************************************************
...
//********************************************************************
void T2K_nueCCinc_XSec_1Dthe_joint::MakePlots() {
//********************************************************************
