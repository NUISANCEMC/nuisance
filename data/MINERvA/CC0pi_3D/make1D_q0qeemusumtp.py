...
fname = "MINERvA_TripleDiffQELike_q0qeemusumtp.root"
hname = "q0qeemusumtp_data_cross_section_with_total_unc"
...
f_out = ROOT.TFile("data_q0qeemusumtp_1D.root","RECREATE")
...
for iz in range(0, nz):
  ...
  for iy in range(0, ny):
    ...
    for ix in range(0, nx):
      ...
      binFromCoord = h_3D.FindBin(x_c, y_c, z_c)
